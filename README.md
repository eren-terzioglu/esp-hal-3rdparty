...
This release was based on the top of [`sync/master.a`](../../../tree/sync/release_v5.1.c)., forked on 2025-06-10 ([`70f358ef1e045d458631409c89b0bf7e24df16e6`](../../../tree/70f358ef1e045d458631409c89b0bf7e24df16e6)), creating the branch [`release/master.a`](../../../tree/release/master.a).
...
#### `components`
The [`components`](./components/) folder contains the components sourced from [`sync/master.a`](../../../tree/sync/master.a) and the additions made to enable building the sources on NuttX. Please note that these components may contain git submodules.
