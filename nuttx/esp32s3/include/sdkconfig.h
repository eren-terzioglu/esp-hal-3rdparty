/* The following section was automatically generated from ESP-IDF's softap
 * example for ESP32-S3 (examples/wifi/getting_started/softAP). Please,
 * don't edit it directly. At the end of this file, there is a section named
 * "Configurations for NuttX": make any required modifications in there.
 */
...
#define CONFIG_ESP_TASK_TIMER_STACK 4096
#define CONFIG_ESP_TASK_TIMER_PRIO (SCHED_PRIORITY_MAX - 10)
#define CONFIG_ESP_TIMER_ISR_AFFINITY_CPU0 1
#define ESP_TIMER_INIT_MASK 0x01
...
#if defined(CONFIG_ESP32S3_DEFAULT_CPU_FREQ_40)
#define CONFIG_ESP_DEFAULT_CPU_FREQ_MHZ_40 1
#elif defined(CONFIG_ESP32S3_DEFAULT_CPU_FREQ_80)
...
#define CONFIG_ULP_COPROC_RESERVE_MEM CONFIG_ESP32S3_ULP_COPROC_RESERVE_MEM
...
#if defined(CONFIG_ESP32S3_FLASH_MODE_QIO)
#  define CONFIG_ESPTOOLPY_FLASHMODE_QIO 1
#  define CONFIG_ESPTOOLPY_FLASHMODE "dio"
#elif defined(CONFIG_ESP32S3_FLASH_MODE_QOUT)
#  define CONFIG_ESPTOOLPY_FLASHMODE_QOUT 1
#  define CONFIG_ESPTOOLPY_FLASHMODE "dio"
#elif defined(CONFIG_ESP32S3_FLASH_MODE_DIO)
#  define CONFIG_ESPTOOLPY_FLASHMODE_DIO 1
#  define CONFIG_ESPTOOLPY_FLASHMODE "dio"
#elif defined(CONFIG_ESP32S3_FLASH_MODE_DOUT)
#  define CONFIG_ESPTOOLPY_FLASHMODE_DOUT 1
#  define CONFIG_ESPTOOLPY_FLASHMODE "dout"
#elif defined(CONFIG_ESP32S3_FLASH_MODE_OCT)
#  define CONFIG_ESPTOOLPY_OCT_FLASH 1
#  define CONFIG_ESPTOOLPY_FLASHMODE_OPI 1
#  define CONFIG_ESPTOOLPY_FLASHMODE "dout"
#endif

#if defined(CONFIG_ESP32S3_FLASH_SAMPLE_MODE_STR)
# define CONFIG_ESPTOOLPY_FLASH_SAMPLE_MODE_STR 1
#elif defined(CONFIG_ESP32S3_FLASH_SAMPLE_MODE_DTR)
...
#  define CONFIG_ESP_CONSOLE_UART_TX_GPIO        CONFIG_ESP32S3_UART1_TXPIN
#  define CONFIG_ESP_CONSOLE_UART_RX_GPIO        CONFIG_ESP32S3_UART1_RXPIN
#elif defined(CONFIG_UART2_SERIAL_CONSOLE) && defined(CONFIG_ESP32S3_UART2)
#  define CONFIG_ESP_CONSOLE_UART                1
#  define CONFIG_ESP_CONSOLE_UART_NUM            2
#  define CONFIG_ESP_CONSOLE_ROM_SERIAL_PORT_NUM 2
#  define CONFIG_ESP_CONSOLE_UART_CUSTOM         1
#  define CONFIG_ESP_CONSOLE_UART_CUSTOM_NUM_1   2
#  define CONFIG_ESP_CONSOLE_UART_TX_GPIO        CONFIG_ESP32S3_UART2_TXPIN
#  define CONFIG_ESP_CONSOLE_UART_RX_GPIO        CONFIG_ESP32S3_UART2_RXPIN
#elif defined(CONFIG_CDCACM_CONSOLE)
#  define CONFIG_ESP_CONSOLE_UART_NUM            -1
#  define CONFIG_ESP_CONSOLE_USB_SERIAL_JTAG     1
#  define CONFIG_ESP_CONSOLE_ROM_SERIAL_PORT_NUM CONFIG_ESP_ROM_USB_OTG_NUM
#elif defined(CONFIG_OTHER_SERIAL_CONSOLE) && defined(CONFIG_ESP32S3_USBSERIAL)
#  define CONFIG_ESP_CONSOLE_UART_NUM            -1
#  define CONFIG_ESP_CONSOLE_USB_SERIAL_JTAG     1
#  define CONFIG_ESP_CONSOLE_ROM_SERIAL_PORT_NUM CONFIG_ESP_ROM_USB_SERIAL_DEVICE_NUM
#endif
...
/* This must come last because a deprecated option can be selected by NuttX */
...
#define CONFIG_ESP_TIMER_TASK_STACK_SIZE CONFIG_ESPRESSIF_HR_TIMER_TASK_STACK_SIZE
