...
#define CONFIG_ESP32S2_DEEP_SLEEP_WAKEUP_DELAY CONFIG_ESP_SLEEP_DEEP_SLEEP_WAKEUP_DELAY
...
#undef CONFIG_MBEDTLS_MPI_INTERRUPT_LEVEL
...
#undef CONFIG_ESP32S2_DATA_CACHE_SIZE
