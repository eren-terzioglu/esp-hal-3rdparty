...
#if defined(CONFIG_ESP32P4_REV_MIN_300) || defined(CONFIG_ESP32P4_REV_MIN_301)
...
#if defined(CONFIG_ESPRESSIF_SPIRAM_BOOT_INIT)
#  define CONFIG_SPIRAM_BOOT_INIT 1
#  define CONFIG_SPIRAM_BOOT_HW_INIT 1
#  define CONFIG_SPIRAM_PRE_CONFIGURE_MEMORY_PROTECTION 1
#endif

#if defined(CONFIG_ESPRESSIF_SPIRAM_MEMTEST)
#  define CONFIG_SPIRAM_MEMTEST 1
#endif

#if defined(CONFIG_ESPRESSIF_SPIRAM_IGNORE_NOTFOUND)
#  define CONFIG_SPIRAM_IGNORE_NOTFOUND 1
#endif

#if defined(CONFIG_ESPRESSIF_SPIRAM_USE_8LINE_MODE)
#  define CONFIG_SPIRAM_USE_8LINE_MODE 1
#  define CONFIG_SPIRAM_MODE_OCT 1
#endif

#if defined(CONFIG_ESPRESSIF_SPIRAM_ECC_ENABLE)
#  define CONFIG_SPIRAM_ECC_ENABLE 1
#endif
...
#if defined(CONFIG_ESPRESSIF_SPIRAM_SPEED_20M)
#  define CONFIG_SPIRAM_SPEED_20M 1
#  define CONFIG_SPIRAM_SPEED 20
#elif defined(CONFIG_ESPRESSIF_SPIRAM_SPEED_80M)
#  define CONFIG_SPIRAM_SPEED_80M 1
#  define CONFIG_SPIRAM_SPEED 80
#elif defined(CONFIG_ESPRESSIF_SPIRAM_SPEED_200M)
#  define CONFIG_SPIRAM_SPEED_200M 1
#  define CONFIG_SPIRAM_SPEED 200
#elif defined(CONFIG_ESPRESSIF_SPIRAM)
/* Keep a deterministic default for ESP32-P4 PSRAM path. */
#  define CONFIG_SPIRAM_SPEED_200M 1
#  define CONFIG_SPIRAM_SPEED 200
#endif
